...
const Reports: React.FC = () => {
  ...
  const modelData = [
    { name: 'Outlier Review', value: scores.isolation_score },
    { name: 'Peer Deviation', value: scores.lof_score },
    { name: 'Statistical Deviation', value: scores.statistical_score },
    { name: 'Peer Comparison', value: scores.peer_score },
    { name: 'Exclusion Match', value: scores.leie_score }
  ];
